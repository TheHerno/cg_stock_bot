...
import { Permission } from "https://deno.land/x/discordeno@v7.0.0/src/types/permission.ts"
...
export interface CommandArgument {
  ...
  type?: "number" | "string" | "...string" | "boolean" | "subcommand" | "member"
...
export interface Argument {
  name: string
  execute: (arg: CommandArgument, parameter: string[], message: Message) => unknown
}
